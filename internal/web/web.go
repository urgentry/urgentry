...
func redirectAlias(target string) http.HandlerFunc {
...
func (h *Handler) RegisterRoutes(mux *http.ServeMux) {
	...
	mux.Handle("GET /crons/{$}", wrap(redirectAlias("/monitors/")))
	mux.Handle("GET /crons/{project_id}/{slug}/{$}", wrap(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		http.Redirect(w, r, "/monitors/"+r.PathValue("project_id")+"/"+r.PathValue("slug")+"/", http.StatusSeeOther)
	})))
