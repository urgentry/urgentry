...
type ColumnarLogSink interface {
	UpsertLogs(ctx context.Context, facts []ColumnarLogFact) error
}
...
func (p *Projector) SetColumnarLogSink(sink ColumnarLogSink) {
	p.logSink = sink
}
